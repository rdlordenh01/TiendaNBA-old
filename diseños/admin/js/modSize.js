...
function cargarselect(id){
    fetch ('http://nba-server4.tk/size.php?prod2='+id, {
        "method": "GET"
    })
    .then(data => data.json()) 
    .then(datos => {
...
function cargarform(id){
    fetch ('http://nba-server4.tk/size.php?id='+id, {
        "method": "GET"
    })
    .then(data => data.json()) 
    .then(datos => {
...
function modificar(){
    ...
    fetch ('http://nba-server4.tk/modSize.php', {
        method: 'POST',
        body: params
    })
    .then(data => data.json()) 
...
function delTalla(){
    ...
    fetch ('http://nba-server4.tk/delSize.php', {
        method: 'POST',
        body: params
    })
    .then(data => data.json()) 
