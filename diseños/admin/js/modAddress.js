...
function cargarselect(id){
    fetch ('http://nba-server.tk/address.php?id='+id, {
        "method": "GET"
    })
    .then(data => data.json()) 
    .then(datos => {
...
function cargarform(id){
    fetch ('http://nba-server.tk/address.php?dir='+id, {
        "method": "GET"
    })
    .then(data => data.json()) 
    .then(datos => {
...
function modificar(){
    ...
    fetch ('http://nba-server.tk/modAdress.php', {
        method: 'POST',
        body: params
    })
    .then(data => data.json()) 
...
function delDireccion(){
    ...
    fetch ('http://nba-server.tk/delAdress.php', {
        method: 'POST',
        body: params
    })
    .then(data => data.json()) 
